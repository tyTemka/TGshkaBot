...
public class Reminder {
    ...
    private int id;   //id напоминания  
    private int groupId; //id user'a
    private String content; //текст напоминания 
    private Type type; //без повторения или с повторением
    ...
    private boolean enabled; //вкл-выкл
    private LocalDateTime createdAt; // когда было создано 
